...
public class TestSortUtils {
	...
	arr[9] = new Student(1717, "Dimitris", "Dimitriou",2017);
        ...
        MyUtils.insertSortAM(arr);
	System.out.println();
	System.out.println("Students sorted by AM (Insertion sort):");
        for (Student arr1 : arr) {
            System.out.println(arr1);
        }

	MyUtils.selectSortSurname(arr);
	System.out.println();
	System.out.println("Students sorted by surname (Selection sort):");
        for (Student arr1 : arr) {
            System.out.println(arr1);
        }

	System.out.println();
	System.out.println("Students sorted by enrollment year (Bubble sort):");
	MyUtils.bubbleSortYear(arr);
        for (Student arr1 : arr) {
            System.out.println(arr1);
        }
